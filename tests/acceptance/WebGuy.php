...
class WebGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeValidHtml5Markup()
     * @return \Codeception\Maybe
     */
    public function canSeeValidHtml5Markup($page) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeValidHtml5Markup', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeValidHtml5Markup($page) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeValidHtml5Markup', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
